...
public class getStuffActivity extends AppCompatActivity {
    ...
    @Override
        ...
        existingAcc.setOnClickListener((view) ->  {
                    ...
                    Intent intent = new Intent(getStuffActivity.this, LoginActivity.class);
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (spinnerItems.equals("What do you wish to give away?")) {
                    Toast.makeText(getStuffActivity.this, "Select category", Toast.LENGTH_SHORT).show();
                    return;
                    ...
                    mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if(!task.isSuccessful()){
                                ...
                                Toast.makeText(getStuffActivity.this, "Error" + error, Toast.LENGTH_SHORT).show();
                            }
                            else{
                                ...
                                userInformation.put("category", "taker" );
                                userInformation.put("search", "taker" + spinnerItems);
                                ...
                                userDatabaseReference.updateChildren(userInformation).addOnCompleteListener(new OnCompleteListener() {
                                    ...
                                    public void onComplete(@NonNull Task task) {
                                        ...
                                        if(task.isSuccessful()) {
                                            Toast.makeText(getStuffActivity.this, "Successful", Toast.LENGTH_SHORT).show();
                                        }else {
                                            Toast.makeText(getStuffActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                        }
                                        finish();
                                ...
                                if(getURI !=null){
                                    ...
                                    uploadTask.addOnFailureListener(new OnFailureListener() {
                                                                        ...
                                                                        public void onFailure(@NonNull Exception e) {
                                                                            Toast.makeText(getStuffActivity.this, "Image upload failed", Toast.LENGTH_SHORT).show();
                                                                        }
                                                ...
                                                result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabaseReference.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if(task.isSuccessful()) {
                                                                    Toast.makeText(getStuffActivity.this, "Image url added", Toast.LENGTH_SHORT).show();
                                                                }else{
                                                                    Toast.makeText(getStuffActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                                }
                                    ...
                                    Intent intent = new Intent(getStuffActivity.this, MainActivity2.class);
                                    startActivity(intent);
                                    finish();
                                    loading.dismiss();
                                }
